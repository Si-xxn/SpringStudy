		...
		<div class="panel-body">
			<ul class="chat">
				<li class="left clearfix" data-rno='12'>
					<div>
						<div class="header">
							<strong class="primary-font">kkk</strong>
							<small class="pull-right text-muted">2024-08-28 14:30</small>
						</div>
						<p>Good job!</p>
					</div>
				</li>	
...
/* console.log("----------------------------")
console.log("reply.js add 함수 실행.....") */
</script>
...
$(".chat").on("click", "li", function(e){
	...
	replyService.get(rno, function(reply){
		...
		modalInputTeplyer.val(reply.replyer);
...
replyService.update({
	...
	replyPageFooter.on("click", "li a", function(e){
		...
		cosole.log("targetPageNum : " + targetPageNum);
